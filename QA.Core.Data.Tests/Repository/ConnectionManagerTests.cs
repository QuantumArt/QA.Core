...
namespace QA.Core.Data.Tests.Repository
{
    ...
    public class ConnectionManagerTests
    {
        ...
        {
            const string connectionString = "Application Name=QP7.Qa_Beeline_Main;Initial Catalog=qp_beeline_main_cis;Data Source=qwe;User ID=publishing;Password=QuantumartHost.SQL;";
            ConnectionManager connectionManager = new ConnectionManager();
